            ...
            <div class="card-content margin" style="margin: 12px;">
                <div class="row">
                    <div class="col s6 m6 l6">
                        <h4 class="cardbox-text light left margin">daftar simpanan Investasi</h4>
                    </div>
                    <!--                    <div class="col s6 m6 l6">-->
...
<div id="modal-tambah" class="modal">
    <?= form_open('simpanan-wajib') ?>
    <div class="modal-content center">
        <div class="row">
            <div class="col s12 m12 center">
                <h5 class="more-text">tambah data simpanan investasi</h5>
                <h5 class="divider"></h5>
            </div>
            ...
            <div class="input-field col s12 m11">
                ...
                <input type="text" name="jenis" value="investasi" hidden>
            </div>
            ...
            <div class="col s12 m12 ">
                <div id="simpanan-alert" class="card green lighten-5 z-depth-1">
                    <div class="card-content green-text ">
                        <p>SIMPANAN INVESTASI : Adalah simpanan yang diharuskan untuk setiap anggota koperasi. Setoran awal minimal Rp 100.000 selanjutnya minimal Rp 50.000.</p>
                    </div>
                </div>
            </div>

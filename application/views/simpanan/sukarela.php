            ...
            <div class="col s12 m12 ">
                <div id="simpanan-alert" class="card green lighten-5 z-depth-1">
                    <div class="card-content green-text ">
                        <p>SIMPANAN TABUNGAN : Adalah jenis produk simpanan yang disediakan untuk anggota yang hendak menambah tabungan selain dari simpanan pokok dan simpanan wajib. Setoran awal minimal sebesar Rp 50.000.</p>
                    </div>
                </div>
            </div>

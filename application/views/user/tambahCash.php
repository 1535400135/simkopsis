				...
				<form action="<?= base_url('pinjaman-cash/proses') ?>" enctype="multipart/form-data" method="post" autocomplete="off">
					...
					<div class="row margin">
						<div class="input-field col s12 m12">
							<input type="text" name="anggota" id="id-anggota" value="<?= $this->session->userdata('user_id') ?>" hidden>
					...
					<div class="row">
						<div class="input-field col s12 m6">
							<a href="<?= base_url('') ?>" class="btn waves-effect col s12 z-depth-0 grey lighten-4 black-text">batalkan</a>
						</div>
						<div class="input-field col s12 m6">

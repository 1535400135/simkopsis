            ...
            <div class="card-content margin" style="margin: 12px;">
                <div class="row">
                    <div class="col s6 m6 l6">
                        <h4 class="cardbox-text light left margin">daftar simpanan pokok</h4>
                    </div>
                    <!--                    <div class="col s6 m6 l6">-->
            ...
            <table class="bordered" id="barang-table">
                ...
                <tbody>
                    ...
                    foreach ($pokok as $key => $value) :
                        if ($value['simpanan_jenis'] === 'investasi') :
                    ?>
                            <tr>
...
<div id="modal-tambah" class="modal">
    <?= form_open('usimpanan-pokok') ?>
    <div class="modal-content center">
        <div class="row">
            <div class="col s12 m12 center">
                <h5 class="more-text">tambah data simpanan pokok</h5>
                <h5 class="divider"></h5>
            </div>
            ...
            <div class="input-field col s12 m11">
                ...
                <input type="text" name="jenis" value="pokok" hidden>
            </div>
            ...
            <div class="col s12 m12 ">
                <div id="simpanan-alert" class="card green lighten-5 z-depth-1">
                    <div class="card-content green-text ">
                        <p>SIMPANAN POKOK : Simpanan bersifat umum yang penyimpanan dan penarikannya dapat dilakukan kapan saja oleh nasabah pada jam kerja. Simpanan awal Rp 25.000 dan selanjutnya minimal Rp 10.000.</p>
                    </div>
                </div>
            </div>

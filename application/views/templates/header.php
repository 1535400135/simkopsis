                ...
                <aside id="left-sidebar-nav">
                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                        ...
                        <li class="user-details cyan darken-2">
                            <div class="row">
                                <?php if (empty($this->session->userdata('profil'))) : ?>
                                    <img src="<?= base_url('assets/images/admin.png') ?>" alt="" class="circle responsive-img valign profile-image">
                                <?php else :?>
                                    <img src="<?= base_url('assets/upload/foto/'. $pengguna->pengguna_foto) ?>" alt="" class="circle responsive-img valign profile-image">
                                <?php endif ?>
                            ...
                            <ul class="collapsible collapsible-accordion">
                                <li class="bold">
                                    ...
                                    <div class="collapsible-body">
                                        <ul>
                                            <li><a href="<?= base_url('simpanan-modal') ?>">Modal</a>
                                            </li>
                                            <li><a href="<?= base_url('simpanan-investasi') ?>">Investasi</a>
                                            </li>
                                            <li><a href="<?= base_url('simpanan-tabungan') ?>">Tabungan</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="bold">
                                    ...
                                    <div class="collapsible-body">
                                        <ul>
                                            ...
                                            <li><a href="<?= base_url('laporan-pinjaman') ?>">Laporan</a>
                                            </li>
                                            <li><a href="<?= base_url('laporan-neraca') ?>">Laporan Neraca</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                        ...
                        <li>
                            <a href="<?= base_url('admin-profil/'. $this->session->userdata('user_id')) ?>"><i class="mdi-action-account-circle"></i> Profil</a>
                        </li>
                        <li>
                        ...
                        <div id="main">
                            ...
                            <div class="wrapper">
                                            ...
                                            <div class="row">
                                                <div class="col col s4 m4 l4">
                                                    <?php if (empty($this->session->userdata('profil'))) : ?>
                                                        <img src="<?= base_url('assets/images/admin.png') ?>" alt="" class="circle responsive-img valign profile-image">
                                                    <?php else :?>
                                                        <img src="<?= base_url('assets/upload/foto/'. $this->session->userdata('profil')) ?>" alt="" class="circle responsive-img valign profile-image">
                                                    <?php endif ?>
                                                </div>
                                                <div class="col col s8 m8 l8">
                                                    <a class="btn-flat  waves-effect waves-light white-text profile-btn" href="#">
                                ...
                                <section id="content">
                                    ...
                                    <!-- atasan -->
                                    <?php
                                    if ($this->session->userdata('level') == 'atasan') :
                                    ?>
                                                    ...
                                                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                                                        ...
                                                        <li class="no-padding">
                                                            <ul class="collapsible collapsible-accordion">
                                                                <li class="bold">
                                                                    <a class="collapsible-header waves-effect waves-cyan">
                                                                        <i class="mdi-action-account-balance-wallet"></i> Status Pinjaman
                                                                    </a>
                                                                    <div class="collapsible-body">
                                                                        <ul>
                                                                            <li><a href="<?= base_url('datar-peminjam') ?>">Daftar Peminjam</a>
                                                                            </li>
                                                                            <li><a href="<?= base_url('status-pinjaman') ?>">Status Pinjaman</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </li>
                                                        ...
                                                        <li class="no-padding">
                                                            <ul class="collapsible collapsible-accordion">
                                                                <li class="bold">
                                                                    ...
                                                                    <div class="collapsible-body">
                                                                        <ul>
                                                                            <li><a href="<?= base_url('usimpanan-wajib') ?>">Simpanan Investasi</a>
                                                                            </li>
                                                                            <li><a href="<?= base_url('usimpanan-sukarela') ?>">Simpanan Tabungan</a>
                                                                            </li>
                                                        ...
                                                        <li class="no-padding">
                                                            <ul class="collapsible collapsible-accordion">
                                                                <li class="bold">
                                                                    ...
                                                                    <div class="collapsible-body">
                                                                        <ul>
                                                                            <li><a href="<?= base_url('upinjaman-cash') ?>">Tunai</a>
                                                                            </li>
                                                                            <li><a href="<?= base_url('upinjaman-noncash') ?>">Non Tunai</a>
                                                                            </li>
                                                        ...
                                                        <li class="no-padding">
                                                            <ul class="collapsible collapsible-accordion">
                                                                <li class="bold">
                                                                    ...
                                                                    <div class="collapsible-body">
                                                                        <ul>
                                                                            <li><a href="<?= base_url('uangsuran-cash') ?>">Tunai</a>
                                                                            </li>
                                                                            <li><a href="<?= base_url('uangsuran-noncash') ?>">Non Tunai</a>
                                                                            </li>
                                                        ...
                                                        <li>
                                                            <a href="<?= base_url('user-profil/'.$this->session->userdata('user_id')) ?>"><i class="mdi-action-account-circle"></i> Profil</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?= base_url('user-pengaturan') ?>"><i class="mdi-action-settings"></i> Pengaturan</a>
                                                        </li>
                                                        <li>
                                                            <a href="#logoutModal" class="modal-trigger"><i class="mdi-action-exit-to-app "></i> Keluar</a>
                                                        </li>
                                                            ...
                                                            <div class="wrapper">
                                                                ...
                                                                <aside id="left-sidebar-nav">
                                                                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                                                                        ...
                                                                        <li class="bold">
                                                                            <a href="<?= base_url('status-pinjaman/'.$this->session->userdata('user_id')) ?>" class="waves-effect waves-cyan">
                                                                                <i class="mdi-social-people"></i> Status Pinjaman
                                                                            </a>
                                                                        </li>
                                                                        ...
                                                                        <li class="no-padding">
                                                                            <ul class="collapsible collapsible-accordion">
                                                                                <li class="bold">
                                                                                    ...
                                                                                    <div class="collapsible-body">
                                                                                        <ul>
                                                                                            <li><a href="<?= base_url('usimpanan-wajib/'.$this->session->userdata('user_id')) ?>">Simpanan Investasi</a>
                                                                                            </li>
                                                                                            <li><a href="<?= base_url('usimpanan-sukarela/'.$this->session->userdata('user_id')) ?>">Simpanan Tabungan</a>
                                                                                            </li>
                                                                        ...
                                                                        <li class="no-padding">
                                                                            <ul class="collapsible collapsible-accordion">
                                                                                <li class="bold">
                                                                                    <a href="<?= base_url('anggota-laporan/'.$this->session->userdata('user_id')) ?>" class="waves-effect waves-cyan">
                                                                                        <i class="mdi-action-book"></i> Laporan
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
